...
Int64utils.prototype.toDecimalString = function (i64) {
  var b = i64.buffer;
  var o = i64.offset;
  if ((!b[o] && !(b[o + 1] & 0xe0)) ||
  (!~b[o] && !~(b[o + 1] & 0xe0))) {
...
Int64utils.prototype.fromDecimalString = function (text) {
...
Int64utils.prototype.toDecimalfromString = function (text) {
  var offset = arguments[1] ? arguments[1] : 0;
  var subStr = text.substring(offset);
  var array = new Int8Array(subStr.length);
  for (var i = 0; i < subStr.length; i++) {
    array[i] = subStr.charCodeAt(i);
  }
  return this.toDecimalString(array.buffer)
}
