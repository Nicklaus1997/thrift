...
Binary.prototype.readByte = function (b) {
  return b > 127 ? b - 256 : b;
}

Binary.prototype.readI16 = function (buff, off) {
  off = off || 0;
  var v = buff[off + 1];
  v += buff[off] << 8;
  if (buff[off] & 128) {
...
Binary.prototype.readI32 = function (buff, off) {
  off = off || 0;
  var v = buff[off + 3];
  v += buff[off + 2] << 8;
  v += buff[off + 1] << 16;
...
Binary.prototype.writeI16 = function (buff, v) {
  buff[1] = v & 0xff;
  v >>= 8;
  buff[0] = v & 0xff;
  return buff;
...
Binary.prototype.writeI32 = function (buff, v) {
  buff[3] = v & 0xff;
  v >>= 8;
  buff[2] = v & 0xff;
  v >>= 8;
...
Binary.prototype.readDouble = function (buff, off) {
  off = off || 0;
...
Binary.prototype.writeDouble = function (buff, v) {
  var m, e, c;
